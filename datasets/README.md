...
> **Nota:** la asignación dataset → clase concreta del currículo (**232 clases** en 9 partes, v3.8.1 — 🎓 232/232 clases · 232/232 notebooks ejecutables · cobertura 100% real) se define al desarrollar el contenido pedagógico de cada bloque. Las descripciones por dataset abajo no incluyen ya un mapeo fijo.
