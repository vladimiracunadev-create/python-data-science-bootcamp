...
> **Nota:** la asignación dataset → clase concreta del currículo (**232 clases** en 9 partes, v3.6.0) se define al desarrollar el contenido pedagógico de cada bloque. Las descripciones por dataset abajo no incluyen ya un mapeo fijo.
