...
- 🗜️ `release_artifacts/PythonDSProgram_windows_portable_v3.8.1.zip` — portable (ZIP, ~274 MB)
- 📦 `dist_installer/PythonDSProgram_Setup_v3.8.1.exe` — instalador (requiere Inno Setup 6)
