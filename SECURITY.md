...
| 🔖 Versión | 🚦 Estado |
|---|---|
| `v3.10.0` (rama `main`) | ✅ activamente desarrollada |

> 🚀 Release actual: [v3.10.0](https://github.com/vladimiracunadev-create/python-data-science-program/releases/tag/v3.10.0) (publicado 2026-07-28) con ZIP portable Windows (Qt nativo, reconstruido con los 232 notebooks reales) + APK Android debug v3.8.1 reutilizado sin cambios + bundles PDF/PPTX del curso completo.
