...
- [x] **🎓 Currículo completo: 232/232 READMEs (100%) · 197/232 notebooks ejecutables** — todas las partes en patrón pedagógico v3.0 con README; las 35 clases dedicadas modernas (Polars, Optuna, Ray Tune, Lightning, etc.) tienen README pero notebook pendiente
- [ ] 📓 Generar las **35 `.ipynb` faltantes** de las clases dedicadas modernas (Polars, Optuna, Ray Tune, Lightning, etc.) — ahora que el lab puede ejecutarlas con kernel Jupyter real
