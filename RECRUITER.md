...
- 🖥️ **app de escritorio nativa para Windows** (PySide6 / Qt nativo · v3.8.1 — sin web, sin localhost, sin WebView; widgets Qt puros con QTreeView, QTextBrowser `setMarkdown`, QScrollArea por celda de notebook · diferencial técnico vs el wrapper pywebview anterior);
...
| App de escritorio Windows | ✅ binario v3.8.1 publicado en release | PySide6 + PyInstaller — ZIP portable slim de 274 MB, sin Flask, sin localhost, sin Edge WebView2 |
| Instalador Windows | ✅ `.exe` Inno Setup publicado en release v3.8.1 | junto al ZIP portable; no requiere permisos de administrador. Pendiente firmarlo con certificado de code-signing (sin firma, SmartScreen avisa la primera vez) |
| App Android | ✅ APK debug v3.8.1 publicado en release | Expo SDK 51, versionCode 39 — 232 clases embebidas, navegación partes → clases → detalle |
...
Release oficial: [**v3.8.1**](https://github.com/vladimiracunadev-create/python-data-science-program/releases/tag/v3.8.1) (publicado 2026-06-19).

- 🖥️ [`PythonDSProgram_windows_portable_v3.8.1.zip`](https://github.com/vladimiracunadev-create/python-data-science-program/releases/download/v3.8.1/PythonDSProgram_windows_portable_v3.8.1.zip) (274 MB) — descomprimir y ejecutar `PythonDSProgram.exe`, ventana Qt nativa sin instalación.
- 📱 [`PythonDSProgram_android_v3.8.1_debug.apk`](https://github.com/vladimiracunadev-create/python-data-science-program/releases/download/v3.8.1/PythonDSProgram_android_v3.8.1_debug.apk) (139 MB) — instalar directo en Android.
- 📄 [`curso-completo.pdf`](https://github.com/vladimiracunadev-create/python-data-science-program/releases/download/v3.8.1/curso-completo.pdf) (1.9 MB) y [`curso-completo.pptx`](https://github.com/vladimiracunadev-create/python-data-science-program/releases/download/v3.8.1/curso-completo.pptx) (2.0 MB) — currículo completo.
- 🔐 [`SHA256SUMS_v3.8.1.txt`](https://github.com/vladimiracunadev-create/python-data-science-program/releases/download/v3.8.1/SHA256SUMS_v3.8.1.txt) — verificación de integridad.
