...
- 🖥️ **app de escritorio nativa para Windows** (PySide6 / Qt nativo · v3.9.0 — sin web, sin localhost, sin WebView; widgets Qt puros con QTreeView, QTextBrowser `setMarkdown`, QScrollArea por celda de notebook · diferencial técnico vs el wrapper pywebview anterior);
...
| App de escritorio Windows | ✅ binario v3.9.0 publicado en release | PySide6 + PyInstaller — reconstruido con los 232 notebooks reales; ZIP portable slim de 278 MB, sin Flask, sin localhost, sin Edge WebView2 |
| Instalador Windows | ⏳ pendiente para v3.9.0 | el release v3.9.0 no incluye instalador Inno Setup `.exe` (no había Inno Setup en el entorno de build) — el ZIP portable es el artefacto autónomo; la versión v3.8.1 del instalador sigue en su release histórico. Pendiente además firmarlo con certificado de code-signing |
| App Android | ✅ APK debug v3.8.1 reutilizado en release v3.9.0 | Expo SDK 51, versionCode 39 (sin cambios) — 232 clases embebidas, navegación partes → clases → detalle |
...
Release oficial: [**v3.9.0**](https://github.com/vladimiracunadev-create/python-data-science-program/releases/tag/v3.9.0) (publicado 2026-07-27).

- 🖥️ [`PythonDSProgram_windows_portable_v3.9.0.zip`](https://github.com/vladimiracunadev-create/python-data-science-program/releases/download/v3.9.0/PythonDSProgram_windows_portable_v3.9.0.zip) (278 MB) — descomprimir y ejecutar `PythonDSProgram.exe`, ventana Qt nativa sin instalación; reconstruida con los 232 notebooks reales.
- 📱 [`PythonDSProgram_android_v3.8.1_debug.apk`](https://github.com/vladimiracunadev-create/python-data-science-program/releases/download/v3.9.0/PythonDSProgram_android_v3.8.1_debug.apk) (139 MB) — instalar directo en Android; APK reutilizado sin cambios desde v3.8.1.
- 📄 [`curso-completo.pdf`](https://github.com/vladimiracunadev-create/python-data-science-program/releases/download/v3.9.0/curso-completo.pdf) (1.9 MB) y [`curso-completo.pptx`](https://github.com/vladimiracunadev-create/python-data-science-program/releases/download/v3.9.0/curso-completo.pptx) (2.0 MB) — currículo completo.
- 🔐 [`SHA256SUMS_v3.9.0.txt`](https://github.com/vladimiracunadev-create/python-data-science-program/releases/download/v3.9.0/SHA256SUMS_v3.9.0.txt) — verificación de integridad.
