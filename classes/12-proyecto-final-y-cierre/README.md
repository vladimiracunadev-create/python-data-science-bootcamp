...
- realizado un anÃ¡lisis exploratorio completo sobre un dataset real;
- limpiado y transformado los datos de forma reproducible;
- construido y evaluado al menos un modelo predictivo;
...
- `ejercicios.md` â€” checklist de entregables
- `homework.md` â€” instrucciones de entrega final
...
2. AnÃ¡lisis exploratorio: estadÃ­sticas + visualizaciones (20 min)
3. Limpieza y transformaciÃ³n de datos (15 min)
4. Modelado y evaluaciÃ³n (20 min)
...
| Criterio | Peso |
|---|---|
| Claridad del anÃ¡lisis exploratorio | 25% |
| Calidad del preprocesamiento | 20% |
| ConstrucciÃ³n y evaluaciÃ³n del modelo | 25% |
