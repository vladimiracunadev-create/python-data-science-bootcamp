...
1. Aplica PCA con 2 componentes sobre `estudiantes.csv` (con al menos 5 variables numéricas). gráfica los puntos en el espacio de 2 componentes y colorea por la variable `aprobado`. ¿Se separan los grupos?
2. Calcula y gráfica la varianza acumulada (scree plot) para 1 hasta n componentes. ¿Cuántos componentes necesitas para explicar el 90% de la varianza?
