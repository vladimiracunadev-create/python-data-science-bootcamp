# Clase 149 — ANOVA (one-way, two-way)
...
[Clase 150 — Tests no paramétricos: Mann-Whitney, Wilcoxon, Kruskal-Wallis](../150-tests-no-parametricos-mann-whitney-wilcoxon-kruskal-wallis/README.md)
