...
Fin de **Parte 0 — Prerrequisitos**. Continuamos con **Machine Learning Clásico**:

[Clase 047 — Panorama del ML: tipos, batch vs online, instance vs model-based](../../parte-1-machine-learning-clasico/047-panorama-del-ml-tipos-batch-vs-online-instance-vs-model-based/README.md)
