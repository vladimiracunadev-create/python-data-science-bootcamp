# Clase 117b — Segment Anything (SAM / SAM 2): foundation model para segmentación
...
[Clase 117c — YOLOv11 práctico: detección + segmentación + pose](../117c-yolov11-deteccion-segmentacion-practica/README.md)
