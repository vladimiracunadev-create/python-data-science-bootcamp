# Clase 103 — Learning rate scheduling
...
[Clase 104 — Regularización: L1/L2, dropout, max-norm, MC dropout (+ Stochastic Depth)](../104-regularizacion-l1-l2-dropout-max-norm-mc-dropout/README.md)
