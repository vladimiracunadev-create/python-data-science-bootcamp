# Clase 127a — CLIP, SigLIP: multimodal embeddings (visión + texto)
...
[Clase 127b — Whisper: ASR / transcripción / traducción de audio](../127b-whisper-asr-audio-transcripcion-traduccion/README.md)
