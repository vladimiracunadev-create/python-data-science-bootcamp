...
- 👉 [Clase 153 — MCP (Model Context Protocol)](../153-mcp-model-context-protocol/README.md)
- 👉 [Clase 129b — Agentes: tool use, ReAct, multi-agent](../154-agentes-tool-use-react-multi-agent/README.md)
- 👉 [Clase 155 — LLM Evaluation: MMLU, MT-Bench, LLM-as-judge](../155-llm-evaluation-mmlu-mtbench-llm-as-judge/README.md)
