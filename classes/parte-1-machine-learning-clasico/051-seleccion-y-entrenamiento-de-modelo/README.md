# Clase 051 — Selección y entrenamiento de modelo
...
[Clase 052 — Fine-tuning: grid search y randomized search](../052-fine-tuning-grid-search-randomized-search/README.md)
