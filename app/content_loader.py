...
def list_classes() -> list[dict[str, str]]:
    ...
    # Currículo v2: las clases viven en classes/parte-N/NNN-tema/.
    # Se detecta una clase por la presencia de un notebook.ipynb.
    notebooks = sorted(CLASS_DIR.rglob("notebook.ipynb"))
    for notebook in notebooks:
        class_dir = notebook.parent
