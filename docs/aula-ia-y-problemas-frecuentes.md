...
2. criterio: enseña cuando una respuesta esta bien, mal o incompleta;
3. mediación: detecta confusion, miedo, bloqueo o copia sin comprensión;
...
- pedir prediccion antes de ejecutar código;
- alternar demostracion guiada con práctica corta;
...
- usar IA para depurar errores, pero no para copiar la solución final sin explicación;
...
- pedir que expliquen línea por línea;
- cambiar una condicion del ejercicio y pedir adaptación;
...
- ofrecer desafío opcional a quienes terminen antes;
