...
La app movil NO ejecuta Python directamente. El flujo es:
...
|---|---|---|
| Ejecucion de codigo | Via Google Colab (browser) | En el mismo navegador (runner local) |
...
Para actualizaciones menores de contenido (sin cambios en el codigo de la app), Expo permite "OTA updates" (over-the-air) que no requieren publicar un nuevo APK.
