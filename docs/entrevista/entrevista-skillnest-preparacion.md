...
Entrevista agendada para el jueves 9 de abril de 2026 a las 15:30. El objetivo no es regalar una consultoria completa, sino mostrar criterio docente, capacidad de implementación y una propuesta inicial realista para el Colegio San Nicolas de Maipu.

## Mensaje central de 90 segundos

"Prepare este repositorio como una base docente real para un bootcamp de Python orientado a Data Science. No solo contiene notebooks o código suelto: contiene progresión de clases, ejercicios, evaluación, guía docente y un entorno local para practicar. Para una primera implementación escolar yo no abriria todo el contenido de una vez; lo acotaría a una ruta inicial de Python, pandas, visualización y un mini proyecto guiado, para asegurar aprendizaje real y una ejecución ordenada."

## Tres ideas que conviene repetir

1. Ensenas con progresión, no con saturacion.
...
2. Abrir `docs/implementación-v1-skillnest-san-nicolas.md` para evidenciar que ya pensaste la adaptación especifica.
...
6. Si hay tiempo, ejecutar `python run_bootcamp.py` o mostrar la carpeta `app/` como evidencia de entorno de práctica.
...
- partiria con Python, pandas y visualización;
- trabajaría con bloques de 90 minutos;
...
- porque muestra secuencia, criterio pedagógico y ejecución;
...
- definicion de evaluación, pago y alcance.
...
"Si esperan una clase de prueba o una personalización mayor, me sirve dejar claro desde ya si eso forma parte de la evaluación del proceso o de una etapa ya pagada de preparación."

## Senales de alerta

- Piden demasiado material especifico antes de hablar de pago.
- Hablan de horas de clase, pero no de preparación, traslado y coordinacion.
...
- Te piden resolverles el diseño del programa antes de contratar.

## Cierre recomendado

"Me interesa mucho trabajar con ustedes y creo que este repositorio muestra bien como puedo aportar. Si les hace sentido el enfoque, el siguiente paso ideal seria confirmar la carga real, el perfil del grupo y el marco de trabajo para ajustar la versión inicial con precision."
