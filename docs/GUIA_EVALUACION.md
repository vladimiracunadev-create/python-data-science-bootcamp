...
| Distribución de escritorio | App nativa Windows con PySide6 / Qt puro (v3.8.1) — sin web, sin localhost, sin WebView; viewer del currículo con tree + tabs README/Notebook | `installer/` · `launcher.py` · `app_desktop/` |
...
| App Windows (PySide6 Qt nativa) | ✅ [binario v3.8.1 publicado en release](https://github.com/vladimiracunadev-create/python-data-science-program/releases/tag/v3.8.1) — ZIP portable slim (274 MB) |
| App Android (Expo/React Native) | ✅ [APK debug v3.8.1 publicado en release](https://github.com/vladimiracunadev-create/python-data-science-program/releases/tag/v3.8.1) (versionCode 39) — 232 clases embebidas, generadas desde `classes/**/README.md` |
