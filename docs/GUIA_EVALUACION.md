...
```
v3.10.0:  232 clases · 9 partes · 🎓 232/232 READMEs · 232/232 notebooks ejecutables · cobertura 100% real — todas las partes completas y modernizadas 2024-2026, el lab con kernel Jupyter ejecuta el 100% del currículo. App Windows nativa con PySide6 (Qt puro, sin web, sin localhost) reconstruida para empaquetar los 232 notebooks reales, como diferencial técnico de la superficie de escritorio.
```
...
| Distribución de escritorio | App nativa Windows con PySide6 / Qt puro (v3.10.0) — sin web, sin localhost, sin WebView; viewer del currículo con tree + tabs README/Notebook, reconstruido con los 232 notebooks reales | `installer/` · `launcher.py` · `app_desktop/` |
...
| App Windows (PySide6 Qt nativa) | ✅ [binario v3.10.0 publicado en release](https://github.com/vladimiracunadev-create/python-data-science-program/releases/tag/v3.10.0) — ZIP portable slim reconstruido con los 232 notebooks reales (273 MB) |
| App Android (Expo/React Native) | ✅ [APK debug reutilizado en release v3.10.0](https://github.com/vladimiracunadev-create/python-data-science-program/releases/tag/v3.10.0) (versionCode 39, sin cambios desde v3.8.1) — 232 clases embebidas, generadas desde `classes/**/README.md` |
