...
| Distribución de escritorio | App nativa Windows con PySide6 / Qt puro (v3.9.0) — sin web, sin localhost, sin WebView; viewer del currículo con tree + tabs README/Notebook, reconstruido con los 232 notebooks reales | `installer/` · `launcher.py` · `app_desktop/` |
...
| App Windows (PySide6 Qt nativa) | ✅ [binario v3.9.0 publicado en release](https://github.com/vladimiracunadev-create/python-data-science-program/releases/tag/v3.9.0) — ZIP portable slim reconstruido con los 232 notebooks reales (278 MB) |
| App Android (Expo/React Native) | ✅ [APK debug reutilizado en release v3.9.0](https://github.com/vladimiracunadev-create/python-data-science-program/releases/tag/v3.9.0) (versionCode 39, sin cambios desde v3.8.1) — 232 clases embebidas, generadas desde `classes/**/README.md` |
