...
| App Android (`mobile/`) | distribución móvil | ✅ [**APK debug publicado en release v3.8.0**](https://github.com/vladimiracunadev-create/python-data-science-program/releases/tag/v3.8.0) (versionCode 38) · **232 clases embebidas** | alumno en movimiento | catálogo generado desde `classes/**/README.md` (`scripts/generate_mobile_curriculum.py`), validado en `tests/test_mobile_curriculum.py`; navegación jerárquica partes → clases → detalle, con buscador y progreso por parte |
