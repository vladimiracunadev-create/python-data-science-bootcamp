...
| Explicación guiada | 15 a 20 min | una idea fuerte, con lenguaje simple y ejemplo claro |
| Demostracion | 15 a 20 min | el docente modela el proceso y verbaliza decisiones |
| Práctica acompanada | 20 a 25 min | el grupo replica, modifica y pregunta |
...
1. traduce contenido técnico a ejemplos comprensibles;
2. detecta bloqueos de comprensión y no solo errores de sintaxis;
3. regula el ritmo para no perder ni al grupo lento ni al grupo rápido;
...
|---|---|
| Evidencia de ejecución | notebook, script, gráfico o tabla |
| Evidencia de comprensión | explicar una línea, un filtro o un resultado |
...
- [plan-evaluación.md](plan-evaluacion.md): como se mide el avance;
- [aula-ia-y-problemas-frecuentes.md](aula-ia-y-problemas-frecuentes.md): uso de tecnología y problemas recurrentes.
